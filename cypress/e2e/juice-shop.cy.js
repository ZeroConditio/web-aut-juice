...
describe('Juice-shop scenarios', () => {
  ...
  context('With auto login', () => {
    ...
    it('Validate product card amount', () =>{
      ...
      SelectAddressPage.addressButton.contains('United Fakedom').click();
      // Click Continue button
      SelectAddressPage.continueButton.click();
      // Create page object - DeliveryMethodPage
      // Select delivery speed Standard Delivery
      DeliveryMethodPage.deliveryType.contains('Standard Delivery').click();
      // Click Continue button
      DeliveryMethodPage.continueButton.click();
      // Create page object - PaymentOptionsPage
      // Select card that ends with "5678"
      PaymentsOptionPage.paymentType.contains('5678').parent().find('[class="mdc-radio__native-control"]').click();
      // Click Continue button
      PaymentsOptionPage.continueButton.click();
      // Create page object - OrderSummaryPage
      // Click on "Place your order and pay"
      OrderSummaryPage.placeOrder.click();
      // Create page object - OrderCompletionPage
      // Validate confirmation - "Thank you for your purchase!"
      OrderCompletionPage.confirmationValidation.should('contain.text', 'Thank you for your purchase!');
    });
